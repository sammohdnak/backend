export default [
    {
        inputs: [
            ...
            { internalType: 'uint256', name: 'defaultSurgeThresholdPercentage', type: 'uint256' },
        ],
        stateMutability: 'nonpayable',
        type: 'constructor',
    },
    { inputs: [], name: 'InvalidSurgeThresholdPercentage', type: 'error' },
    ...
    { inputs: [], name: 'ZeroDivision', type: 'error' },
    {
        ...
        name: 'StableSurgeHookExampleRegistered',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'newSurgeThresholdPercentage', type: 'uint256' },
        ],
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: 'surgeThresholdPercentage', type: 'uint256' },
            { internalType: 'uint256', name: 'staticFeePercentage', type: 'uint256' },
        ],
