...
export const pulsechainV4NetworkData = config.SEPOLIA;


export const pulsechainV4NetworkConfig: NetworkConfig = {
    data: pulsechainV4NetworkData,
    contentService: new GithubContentService(),
    provider: new ethers.providers.JsonRpcProvider({ url: pulsechainV4NetworkData.rpcUrl, timeout: 60000 }),
    poolAprServices: [
        new YbTokensAprService(pulsechainV4NetworkData.ybAprConfig, pulsechainV4NetworkData.chain.prismaId),
        new BoostedPoolAprService(),
        new SwapFeeAprService(),
        new GaugeAprService(tokenService, [pulsechainV4NetworkData.bal!.address]),
        // new VeBalProtocolAprService(pulsechainV4NetworkData.rpcUrl),
    ...
    services: {
        balancerSubgraphService: new BalancerSubgraphService(
            pulsechainV4NetworkData.subgraphs.balancer,
            pulsechainV4NetworkData.chain.id,
        ),
    },
    /*
