...
export const pulsechainNetworkData = config.SEPOLIA;


export const pulsechainNetworkConfig: NetworkConfig = {
    data: pulsechainNetworkData,
    contentService: new GithubContentService(),
    provider: new ethers.providers.JsonRpcProvider({ url: pulsechainNetworkData.rpcUrl, timeout: 60000 }),
    poolAprServices: [
        new YbTokensAprService(pulsechainNetworkData.ybAprConfig, pulsechainNetworkData.chain.prismaId),
        new BoostedPoolAprService(),
        new SwapFeeAprService(),
        new GaugeAprService(tokenService, [pulsechainNetworkData.bal!.address]),
        // new VeBalProtocolAprService(pulsechainNetworkData.rpcUrl),
    ...
    services: {
        balancerSubgraphService: new BalancerSubgraphService(
            pulsechainNetworkData.subgraphs.balancer,
            pulsechainNetworkData.chain.id,
        ),
    },
    /*
